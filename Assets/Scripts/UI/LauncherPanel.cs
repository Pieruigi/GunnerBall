...
namespace Zoca.UI
{
    public class LauncherPanel: MonoBehaviourPunCallbacks
    {
        #region properties
        ...
        void OpenMapSelector(int numOfPlayers)
        {
            ...
            mapSelectorPanel.GetComponent<MapSelectorPanel>().Open(!PhotonNetwork.OfflineMode, numOfPlayers);
            //gameObject.SetActive(false);
        }
        ...
        public void CreateRoom(int maxPlayers, int mapId)
        {
            ...
            if(!PhotonNetwork.OfflineMode)
                ...
                Launcher.Instance.CreateRoomOffline(maxPlayers, mapId);
